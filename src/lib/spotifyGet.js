const { default: spotifyApi } = require("./spotify");
...
export async function getTopAlbums(time_range, limit, count=0) { // data returned as a promise if successful

    if (count >= 5) {
        return handleError("", "Too many retries");
    }
    ...
    try {
        ...
        try {
            ...
            return getTopAlbums(time_range, limit, count + 1);
